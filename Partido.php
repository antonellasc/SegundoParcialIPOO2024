...
public function __toString(){
    ...
    // 3. Implementar en la clase Partido el método darEquipoGanador() que retorna el equipo ganador de un partido 
    ...
    // 5. Implementar el método coeficientePartido() en la clase Partido el cual retorna el valor obtenido 
    ...
    public function coeficientePartido(){
        ...
        $cantJugE1 = $equipo1->getCantJugadores();
        $equipo2 = $this->getObjEquipo2();
        $cantJugE2 = $equipo2->getCantJugadores();
        $coeficiente = $this->getCoefBase() * ($this->getCantGolesE1() + $this->getCantGolesE2()) * ($cantJugE1 + $cantJugE2);
        return $coeficiente;
    }
